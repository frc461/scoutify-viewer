...
function new_team(team_number, matches, name, rank) {
    var graph_array = [];
    var graph_count = 0;
    $("#accordion").append("<p></p><div class='panel panel-default'><div class='panel-heading'><h4 class='panel-title'><a id=\"toggley-thing" + team_number + "\" class='accordion-toggle' data-toggle='collapse' data-parent='#accordion' href='#collapse" + team_number + "'>"+ rank +". Team " + team_number +": " + name + "</a></h4></div><div id='collapse" + team_number + "'class='panel-collapse collapse'> <div class='panel-body table-body' style='overflow:auto;'><span><h1 class=\"team_num\">"+ team_number +"<p><p><p> Click on the box -></h1><div class=\"graph_div\"><div id='graph"+ team_number+"' class='graph'></div></div></span><br><table class='table'><thead><tr id='erste" + team_number + "'><th>Team Number</th></tr></thead><tbody id='dritte" + team_number + "'><tr id='zweite"+ team_number +"0'><td>" + team_number+"</td></tr></tbody></table></div></div>" );
    $("#toggley-thing"+team_number).click(function() {
